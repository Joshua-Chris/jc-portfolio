  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
          ...
          <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>Joshua Chris</h1>
          ...
          <div>
            <button className='group text-white rounded-lg border-2 border-[#8892b0] px-6 py-3 my-2 flex items-center hover:bg-blue-600 hover:border-blue-600'>
              View Work <span className='group-hover:rotate-90 duration-300'><HiArrowNarrowRight className='ml-4' /></span>
            </button>
          </div>
        </div>
    </div>
